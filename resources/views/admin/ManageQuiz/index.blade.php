<x-app-layout>
    @section('breadcrumbs')
    {{ Breadcrumbs::render('Penjadwalan') }}
    @endsection
        ...
        <div class="section-body">
            ...
            <div class="relative flex flex-col w-full h-full text-gray-700 bg-white shadow-md rounded-xl bg-clip-border">
                ...
                {{--  <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5">  --}}
                    <table class="py-9 w-full border-collapse bg-white text-left text-sm text-gray-500">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex justify-start gap-4">
                                            <a x-data="{ tooltip: 'Atur Soal Untuk Ujian Ini' }" href="/admin/ujian/{{ $quiz->id }}/setquestion" title="Atur Soal Untuk Ujian Ini">
                                                <i class="fa-solid fa-file-circle-plus fa-xl" style="color: #29943a;"></i>
                                            </a>
                                            <a x-data="{ tooltip: 'Edit' }" href="#" title="Perbarui Ujian" @click="my_modal_3.showModal()">
                                                <i class="fa-solid fa-pen fa-xl "></i>
                                            </a>
                                            <a x-data="{ tooltip: 'Delete' }" href="/ujian/delete/{{ $quiz->id }}" title="Hapus Ujian">
                                                <i class="fa-regular fa-trash-can fa-xl" style="color: #940000;"></i>
                                            </a>
