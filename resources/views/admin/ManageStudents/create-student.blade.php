<x-app-layout>
    <div class="card w-full bg-base-100 shadow-xl my-4">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{route('student.index')}}" method="POST" class="flex flex-col">
                @csrf
                <input required value="{{old('nis')}}" name="nis" type="text" placeholder="Masukkan Nis" class="input input-bordered w-full my-2 sm:text-xl" autofocus />
                ...
                <input required value="{{old('password')}}" name="password" type="password" placeholder="Masukkan Password Setidaknya 8 karakter [A-Z-0-9]" class="input input-bordered w-full my-2 sm:text-xl" />
                ...
                <div class="justify-center my-2">
                    <a class="btn btn-block my-2" href="{{route('student.index')}}">Cancel</a>
