<button
    class="inline-block rounded px-6 py-2.5 text-xs font-medium uppercase leading-tight text-white dark:text-black shadow-md transition duration-150 ease-in-out hover:bg-primary-700 dark:hover:bg-secondary-700 hover:shadow-lg focus:bg-primary-700 dark:focus:bg-secondary-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-primary-800 dark:active:bg-secondary-800 active:shadow-lg"
